...
* xref:200-ops/lab_5_observability.adoc[Configure Red Hat OpenShift Logging with Azure Blob Storage]
...
* xref:500-cluster-mgmt/arc/observability.adoc[Configure Red Hat OpenShift Logging with Azure Blob Storage]
endif::[]
